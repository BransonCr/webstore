...
<%!
	...
	//Change This back to masters for testing.
	// private String urlForLoadData = "jdbc:sqlserver://cosc304_sqlserver:1433;DatabaseName=orders;TrustServerCertificate=True";
	 private String urlForLoadData = "jdbc:sqlserver://cosc304_sqlserver:1433;DatabaseName=master;TrustServerCertificate=True";
	// Connection
